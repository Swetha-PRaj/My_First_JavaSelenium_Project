@3558_4079_creatingB2Bseller
Feature: TC3558, 4079 : verify that seller level agreement is not there for newly added B2B seller

  Scenario Outline: TC3558_4079_Test seller level agreement is not there for newly added B2B seller
    ...
    Examples: 
      ...
      | swetha.pr@storelens.com | Store User | WEEKDAY | Sweden  | Drottninggatan 63 | testerswathi135@gmail.com | All Sellers |Tester2|
