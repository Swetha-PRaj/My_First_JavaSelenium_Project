...
Feature: TC-3169,3262,3169,3443,5487,5488,5490 : Testing Login Functionality , regestering and cancelling Item
  ...
  Scenario Outline: TC3169_3262_3269_3443_5487_5488_5490_Verify user can login and register an item in Resale portal and cancel the resgistered item
    ...
    Examples: 
      | Brand   | Country | Store             | Service | StoreStatus | url                | username             | password               | Store_Name                   | Brandname | Gender | Category | Condition | Color | Pattern | Material | Unsolditem              | status         | fromDate | fromYear | fromMonth | todate | toYear | toMOnth | availableSlot | setmonth | setyear | setDate |
      ...
      | WEEKDAY | Sweden  | Drottninggatan 63 | Resell  | Store Open  | resale_portal_url1 | resale_portal_userid | resale_portal_password | Drottninggatan 63, Stockholm | Addidas   | Women  | Dresses  | Vintage   | Black | Dots    | Cotton   | Pick-up item from store | Pre-registered |       11 |     2022 | May       |     11 |   2024 | May     | 10:00         |     2023 | May     |      19 |
