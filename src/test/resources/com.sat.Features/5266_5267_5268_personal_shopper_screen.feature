...
@TC5266_5267_5268_personal_shopper_screen
Feature: TC 5266 :Verify user able to see the personal shopper screen in the Admin tool app for Brand.

 @TC_5266_5262-Verify_user_able_to_see_the_personal_shopper_screen_in_the_Admin_tool_app_for_Brand.
  ...
  @TC_5267_5262-Verify_user_able_to_see_the_personal_shopper_screen_in_the_Admin_tool_app_for_Brand.
  Scenario Outline: Verify user able to see the personal shopper screen in the Admin tool app for Brand.
    Given User Navigate to New Admin Tool App
    When User select "<country>" and "<brand>"
    Then user scroll down to till element is visible in Admin Tool
 ...
 @TC5268_5266-Verify_user_able_to_Remove_the_Access_from_personal_shopper_screen_in_the_Admin_tool_app_for_Brand.
