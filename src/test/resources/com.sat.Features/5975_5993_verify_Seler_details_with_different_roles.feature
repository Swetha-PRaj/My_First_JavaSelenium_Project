...
Feature: TC5975 :Verify BrandManager and Admin_role Is Able To See Seller Name, Email and PhoneNo
  ...
  Scenario Outline: 5993_5742_Verify_BrandManager_and_Admin_role_Is_Able_To_See_Seller_Name_Email_and_PhoneNo
    ...
    Examples: 
      ...
      | swetha.pr@storelens.com | Admin         | WEEKDAY | Sweden  | Drottninggatan 63 | testerswathi135@gmail.com | All Sellers |               1 | Pickup      | Pending | First      | Last      | Email         | Phone        | Verify    | Commission | CANCEL | SAVE |
      | swetha.pr@storelens.com | Brand Manager | WEEKDAY | Sweden  | Drottninggatan 63 | testerswathi135@gmail.com | All Sellers |               1 | Pickup      | Pending | First      | Last      | Email         | Phone        | Verify    | Commission | CANCEL | SAVE |
  ...
  Scenario Outline: 5975_5742_Verify_Store_and_Store_Manager_Is_Able_To_See_Seller_Name_Email_and_PhoneNo
    ...
    Examples: 
      | User                    | Role          | Brand   | Country | Store             | existingseller            | tab         | Number of Items | Unsold Item | status  | First_name | Last_name | Email_address | Phone_number | Verify_ID | Commission | Cancel | SAVE |
      | swetha.pr@storelens.com | Store Manager | WEEKDAY | Sweden  | Drottninggatan 63 | testerswathi135@gmail.com | All Sellers |               1 | Pickup      | Pending | First      | Last      | Email         | Phone        | Verify    | Commission | CANCEL | SAVE |
