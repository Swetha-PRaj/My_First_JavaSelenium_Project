...
@6067_5742_Validate_in_Item_details_page_Unsold_item_field_and_Store_field_is_hidden_when_we_open_item_from_Instore_screen.
Feature: TC 6067 :Validate in Item details page Unsold item field and Store field is hidden when we open item from Instore screen.

  @TC_6067-Validate_in_Item_details_page_Unsold_item_field_and_Store_field_is_hidden_when_we_open_item_from_Instore_screen.
